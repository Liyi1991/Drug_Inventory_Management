...
<center> 
	<div>
	    <h4 id="h01">Checking-Out Input</h4> 
	</div>
  	<div>
   	<form:form method="post" action="process-checkOut.html" modelAttribute="checking_history">
    <table id="t01">
     	<tr>
      		<td> Drug ID :</td>
     	...
     	<tr>
      		<td><input id="in01" type="submit" value="Checking-Out"/></td>
     	</tr>     
    </table>
    </form:form>  
  </div>
   ...
   <div id="d02">
        <table border="3pt ridge lightgrey" cellpadding="1">
            <caption>Checking_Out Result</caption>
            <tr>
                <td>Checking_ID</td>
                <td>Drug_ID</td>
                <td>Warehouse_ID</td>
