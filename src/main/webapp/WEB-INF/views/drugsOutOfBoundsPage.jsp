...
<title>drugs out of bounds list page</title>
<style type="text/css">
body{
...
<center> 
   <div>
        <table border="3pt ridge lightgrey" cellpadding="1">
            <caption >Drugs Out of Bounds List</caption>
            <tr>
                <td>Drug_ID</td>
                <td>Generic_Name</td>
                <td>Upper_Bound</td>
         ...
         <c:if test="${not empty drug_warehouseList}">
            <c:forEach var="listValue" items="${drug_warehouseList}">
                <tr>
                    ...
                    <td><c:out value="${listValue.drug.upperbound}"/></td>
                    <td><c:out value="${listValue.drug.lowerbound}"/></td>
